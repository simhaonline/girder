#!/bin/bash
export PYTHONPATH=''
export SPEC_FILE='/opt/girder/girder/web_client/test/spec/customWidgetsSpec.js'
export ASSETSTORE_TYPE='filesystem'
export WEB_SECURITY='true'
export ENABLED_PLUGINS=''
export GIRDER_TEST_DB='mongodb://localhost:27017/girder_test_web_client_custom_widget'
export GIRDER_TEST_ASSETSTORE='web_client_custom_widget'
